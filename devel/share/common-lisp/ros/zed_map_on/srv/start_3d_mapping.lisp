...
(cl:defmethod cl:initialize-instance :after ((m <start_3d_mapping-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'start_3d_mapping-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name zed_map_on-srv:<start_3d_mapping-request> is deprecated: use zed_map_on-srv:start_3d_mapping-request instead.")))

(cl:ensure-generic-function 'resolution-val :lambda-list '(m))
(cl:defmethod resolution-val ((m <start_3d_mapping-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_map_on-srv:resolution-val is deprecated.  Use zed_map_on-srv:resolution instead.")
  (resolution m))
...
(cl:defmethod max_mapping_range-val ((m <start_3d_mapping-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_map_on-srv:max_mapping_range-val is deprecated.  Use zed_map_on-srv:max_mapping_range instead.")
  (max_mapping_range m))
...
(cl:defmethod fused_pointcloud_freq-val ((m <start_3d_mapping-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_map_on-srv:fused_pointcloud_freq-val is deprecated.  Use zed_map_on-srv:fused_pointcloud_freq instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<start_3d_mapping-request>)))
  ...
  "zed_map_on/start_3d_mappingRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'start_3d_mapping-request)))
  "Returns string type for a service object of type 'start_3d_mapping-request"
  "zed_map_on/start_3d_mappingRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <start_3d_mapping-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'start_3d_mapping-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name zed_map_on-srv:<start_3d_mapping-response> is deprecated: use zed_map_on-srv:start_3d_mapping-response instead.")))

(cl:ensure-generic-function 'done-val :lambda-list '(m))
(cl:defmethod done-val ((m <start_3d_mapping-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zed_map_on-srv:done-val is deprecated.  Use zed_map_on-srv:done instead.")
  (done m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<start_3d_mapping-response>)))
  ...
  "zed_map_on/start_3d_mappingResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'start_3d_mapping-response)))
  "Returns string type for a service object of type 'start_3d_mapping-response"
  "zed_map_on/start_3d_mappingResponse")
