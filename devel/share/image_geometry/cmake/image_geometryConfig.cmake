...
if("TRUE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /home/nvidia/zed-ros/src/zed-ros-testing/vision_opencv/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/nvidia/zed-ros/devel)
  ...
  set(image_geometry_INSTALL_PREFIX /home/nvidia/zed-ros/install)
...
if(NOT "/home/nvidia/zed-ros/src/zed-ros-testing/vision_opencv/image_geometry/include;/usr/include/opencv4 " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/zed-ros/src/zed-ros-testing/vision_opencv/image_geometry/include;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/zed-ros/src/zed-ros-testing/vision_opencv/image_geometry/${idir}'.  ${_report}")
    endif()
