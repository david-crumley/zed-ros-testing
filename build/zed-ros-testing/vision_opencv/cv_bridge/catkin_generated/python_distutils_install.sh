...
echo_and_run cd "/home/nvidia/zed-ros/src/zed-ros-testing/vision_opencv/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/nvidia/zed-ros/src/zed-ros-testing/vision_opencv/cv_bridge/setup.py" \
    build --build-base "/home/nvidia/zed-ros/build/zed-ros-testing/vision_opencv/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
